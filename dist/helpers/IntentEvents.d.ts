...
declare type EmojiCrud = ICrud<"emoji">;
declare type StickerCrud = ICrud<"sticker">;
declare type GuildBanAddable = IAddable<"guildBan">;
declare type GuildCrud = ICrud<"guild"> | 'guildUnavailable';
declare type GuildMemberCrud = IAddable<"guildMember"> | IUpdateable<"guildMember"> | 'guildMemberAvailable';
