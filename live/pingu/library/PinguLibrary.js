...
function errorLog(client, message, messageContent, err, params = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let errorID = fs.readdirSync('../../../../../../errors').filter(file => file.endsWith('.json')).length;
        //Write or append to errorfile
        let errorFilePath = `../../../../../../errors/${errorID}.json`;
...
function latencyCheck(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!pingChannel)
            return DanhoDM(`Couldn't get #ping-log-🏓 channel in Pingu Support, ${PinguLibrary.PinguSupportInvite}`);
...
function AchievementCheckType(client, achieverType, achiever, key, keyType, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return (function notify() {
            switch (achieverType) {
                case 'USER': return config.notify(client, achiever, achievement);
                case 'GUILDMEMBER': return config.notify(client, achiever, achievement);
                case 'GUILD': return config.notify(client, achiever, achievement);
                default: return null;
            }
        })();
    });
