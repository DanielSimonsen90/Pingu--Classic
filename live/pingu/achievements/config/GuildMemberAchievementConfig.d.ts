...
export declare class GuildMemberAchievementConfig extends AchievementConfigBase {
    ...
    static notify<Key extends keyof GuildMemberAchievementType>(client: Client, achiever: GuildMember, achievement: GuildMemberAchievement<Key, GuildMemberAchievementType[Key]>, config: GuildMemberAchievementConfig): any;
}
