...
export declare class UserAchievementConfig extends AchievementConfigBase {
    ...
    notify<Key extends keyof UserAchievementType>(client: Client, achiever: User, achievement: UserAchievement<Key, UserAchievementType[Key]>): Promise<import("discord.js").Message>;
}
