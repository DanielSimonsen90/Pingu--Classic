...
class PinguClientShell extends discord_js_1.Client {
    static Clients = exports.Clients;
    constructor(config, permissions, options) {
        super(options);
        this.config = config;
        this.permissions = new PermissionsManager_1.default(this, permissions);
        this.emotes = new EmojiCollection_1.default(this);
        this.pGuilds = new PinguCollection_1.default(this, 'pingu-guild-log', 'PinguGuild', g => new __1.PinguGuild(g, g.owner()), c => c.guilds);
        this.pUsers = new PinguCollection_1.default(this, 'pingu-user-log', 'PinguUser', u => new __1.PinguUser(u), c => c.users);
    ...
    async onceReady() {
        ...
        this.badges = new discord_js_1.Collection(PinguBadge_1.TempBadges.map((temp, name) => {
            ...
            return [name, new PinguBadge_1.default(name, emoji, temp.weight)];
        }));
...
exports.default = PinguClientShell;
