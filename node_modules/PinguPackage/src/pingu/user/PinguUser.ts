...
export async function WritePUser(client: Client, user: User, scriptName: string, succMsg: string, errMsg: string) {
    return DBExecute(client, async mongoose => {
        ...
        pUserLog(client, scriptName, (created ? succMsg : errMsg));
        return pUser;
    });
}
...
export async function UpdatePUser(client: Client, updatedProperty: PinguUserUpdate, pUser: PinguUser, scriptName: string, succMsg: string, errMsg: string): Promise<PinguUser> {
...
export class PinguUser {
    ...
    public static async UpdatePUser(client: Client, updatedProperty: PinguUserUpdate, pUser: PinguUser, scriptName: string, succMsg: string, errMsg: string): Promise<PinguUser> {
    ...
    public static async IsUpdated(preUser: User, user: User) {
