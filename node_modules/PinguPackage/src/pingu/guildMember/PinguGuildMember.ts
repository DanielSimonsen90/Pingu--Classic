...
export async function UpdatePGuildMember(guild: Guild, pGuildMember: PinguGuildMember, scriptName: string, succMsg: string, errMsg: string) {
    let pGuild = await GetPGuild(guild);
    pGuild.members.set(pGuildMember._id, pGuildMember);
    return UpdatePGuild(guild.client, { members: pGuild.members }, pGuild, scriptName, succMsg, errMsg);
}
