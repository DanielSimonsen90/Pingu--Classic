import { Client, ClientEvents, ClientOptions, Collection, TextChannel, User, Guild, PermissionString, MessageEmbed, Message, MessageAttachment } from "discord.js";
...
export class PinguClient extends BasePinguClient<PinguClientEvents> {
    ...
    public getEmote(name: string, emoteGuild: Guild) {
        const dead = '😵';

        if (!name || !emoteGuild) return dead;
