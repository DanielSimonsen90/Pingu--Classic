...
export async function pGuildLog(client: Client, script: string, message: string, err?: Error) {
    var pinguGuildLog = getTextChannel(client, SavedServers.PinguSupport(client).id, "pingu-guild-log-🏡");
...
export async function pUserLog(client: Client, script: string, message: string, err?: Error) {
    var pinguUserLog = getTextChannel(client, SavedServers.PinguSupport(client).id, "pingu-user-log-🧍");
