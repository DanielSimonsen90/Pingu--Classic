import {
    ...
    User, PermissionString, Snowflake, TextChannel
} from 'discord.js';
...
export async function errorLog(client: Client, message: string, messageContent?: string, err?: Error, params: errorLogParams = {}) {
    ...
    let errorID = errorCache.size;
    
    //Write or append to errorfile
    let errorFilePath = `./errors/${errorID}.json`;
    fs.writeFile(errorFilePath, JSON.stringify({...err, ...params}), () => consoleLog(client, `Created error file for error #${errorID}.`));
