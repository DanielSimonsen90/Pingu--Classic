...
import { CacheDevelopers, isPinguDev, Developers } from './developers';
...
class PinguLibrary {
    ...
    //#region Servers
    public static PinguSupportInvite = `https://discord.gg/gbxRV4Ekvh`;
    ...
    public static CacheDevelopers(client: Client) { return CacheDevelopers(client); }
    ...
    //#region Log Channels
    public static errorCache = new Collection<number, Message[]>();

    public static async errorLog(client: Client, message: string, messageContent?: string, err?: Error, errorID?: number) {
        return errorLog(client, message, messageContent, err, errorID);
    }
