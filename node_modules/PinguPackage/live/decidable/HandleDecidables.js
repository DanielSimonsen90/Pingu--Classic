            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (decidablesType) {
                    case DecidablesEnum.Giveaway:
                        pGuild.settings.config.giveawayConfig = new config_1.GiveawayConfig({
                    ...
                    case DecidablesEnum.Poll:
                        pGuild.settings.config.pollConfig = new config_1.PollConfig({
                            firstTimeExecuted, channel, pollRole: managerRole, polls: []
                        });
                        break;
                    case DecidablesEnum.Suggestion:
                        pGuild.settings.config.suggestionConfig = new config_1.SuggestionConfig({
                            firstTimeExecuted, channel, managerRole, suggestions: []
                        });
                        break;
                    case DecidablesEnum.Theme:
                        pGuild.settings.config.themeConfig = new config_1.ThemeConfig({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function GetGiveawayWinner(decidable) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const config = decidablesType == DecidablesEnum.Giveaway ? pGuild.settings.config.giveawayConfig : pGuild.settings.config.themeConfig, winnerRole = config.winnerRole, allowSameWinner = config.allowSameWinner;
...
function RemoveDecidables(message, pGuild, type, decidables) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!decidables || !decidables.length || !decidables[0])
            return;
        decidables.forEach(d => type == DecidablesEnum.Giveaway ? pGuild.settings.config.giveawayConfig.giveaways.splice(pGuild.settings.config.giveawayConfig.giveaways.indexOf(d), 1) :
            type == DecidablesEnum.Poll ? pGuild.settings.config.pollConfig.polls.splice(pGuild.settings.config.pollConfig.polls.indexOf(d), 1) :
                type == DecidablesEnum.Suggestion ? pGuild.settings.config.suggestionConfig.suggestions.splice(pGuild.settings.config.suggestionConfig.suggestions.indexOf(d), 1) :
                    pGuild.settings.config.themeConfig.themes.splice(pGuild.settings.config.themeConfig.themes.indexOf(d), 1));
        ...
        switch (type) {
            case DecidablesEnum.Giveaway: return pGuild.settings.config.giveawayConfig.giveaways;
            case DecidablesEnum.Poll: return pGuild.settings.config.pollConfig.polls;
            case DecidablesEnum.Suggestion: return pGuild.settings.config.suggestionConfig.suggestions;
            case DecidablesEnum.Theme: return pGuild.settings.config.themeConfig.themes;
        }
    });
}
...
function UpdatePGuild(client, pGuild, decidableType, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield PinguGuild_1.PinguGuild.UpdatePGuild(client, (decidableType == DecidablesEnum.Giveaway ? { giveawayConfig: pGuild.settings.config.giveawayConfig } :
            decidableType == DecidablesEnum.Poll ? { pollConfig: pGuild.settings.config.pollConfig } :
                decidableType == DecidablesEnum.Suggestion ? { suggestionConfig: pGuild.settings.config.suggestionConfig } :
                    { themeConfig: pGuild.settings.config.themeConfig }), pGuild, `HandleDecidables: ${decidableType}`, succMsg, errMsg);
    });
}
function SaveVerdictToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        let { pGuild, message, decidablesType } = params;
        const arr = (decidablesType == DecidablesEnum.Giveaway ? pGuild.settings.config.giveawayConfig.giveaways :
            decidablesType == DecidablesEnum.Poll ? pGuild.settings.config.pollConfig.polls :
                decidablesType == DecidablesEnum.Suggestion ? pGuild.settings.config.suggestionConfig.suggestions :
                    pGuild.settings.config.themeConfig.themes);
...
function AddDecidableToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (decidablesType) {
            case DecidablesEnum.Giveaway: pGuild.settings.config.giveawayConfig.giveaways.push(decidable);
            case DecidablesEnum.Poll: pGuild.settings.config.pollConfig.polls.push(decidable);
            case DecidablesEnum.Suggestion: pGuild.settings.config.suggestionConfig.suggestions.push(decidable);
            case DecidablesEnum.Theme: pGuild.settings.config.themeConfig.themes.push(decidable);
        }
