    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        collector.on('collect', (input) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (collectorCount) {
                case 0:
                    reply = Find('Role', hostDone ? `${decidablesType} Winner` : staffRoleType, 'Create', userInput);
                    break;
                case 1:
                    if (!hostDone) {
                ...
                case 3:
                    ...
                    if ([DecidablesTypes.Giveaway, DecidablesTypes.Theme])
        ...
        function GetGiveawayWinner(decidable) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function UpdatePGuildWinners() {
                    return __awaiter(this, void 0, void 0, function* () {
                        for (var i = 0; i < winners.length; i++) {
                            decidable.winners.push(new index_1.PGuildMember(sent.guild.member(winners[i])));
                        }
                    });
                }
            });
