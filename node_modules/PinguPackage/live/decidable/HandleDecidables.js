...
function HandleDecidables(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (firstTimeExecuted || args[0] == 'setup')
            ...
            return ListDecidables(params, Is(DecidablesEnum.Giveaway) ? pGuild.settings.giveawayConfig.giveaways :
        ...
        //Giveaway reroll
        if (reroll())
            return yield Reroll(params, embed, (Is(DecidablesEnum.Giveaway) ? pGuild.settings.giveawayConfig.giveaways : pGuild.settings.themeConfig.themes).find(d => d._id == value));
        //Announce decidable
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (decidablesType) {
                    case DecidablesEnum.Giveaway:
                        pGuild.settings.giveawayConfig = new config_1.GiveawayConfig({
                    ...
                    case DecidablesEnum.Poll:
                        pGuild.settings.pollConfig = new config_1.PollConfig({
                            firstTimeExecuted, channel, pollRole: managerRole, polls: []
                        });
                        break;
                    case DecidablesEnum.Suggestion:
                        pGuild.settings.suggestionConfig = new config_1.SuggestionConfig({
                            firstTimeExecuted, channel, managerRole, suggestions: []
                        });
                        break;
                    case DecidablesEnum.Theme:
                        pGuild.settings.themeConfig = new config_1.ThemeConfig({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function GetGiveawayWinner(decidable) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const config = decidablesType == DecidablesEnum.Giveaway ? pGuild.settings.giveawayConfig : pGuild.settings.themeConfig, winnerRole = config.winnerRole, allowSameWinner = config.allowSameWinner;
...
function RemoveDecidables(message, pGuild, type, decidables) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!decidables || !decidables.length || !decidables[0])
            return;
        decidables.forEach(d => type == DecidablesEnum.Giveaway ? pGuild.settings.giveawayConfig.giveaways.splice(pGuild.settings.giveawayConfig.giveaways.indexOf(d), 1) :
            type == DecidablesEnum.Poll ? pGuild.settings.pollConfig.polls.splice(pGuild.settings.pollConfig.polls.indexOf(d), 1) :
                type == DecidablesEnum.Suggestion ? pGuild.settings.suggestionConfig.suggestions.splice(pGuild.settings.suggestionConfig.suggestions.indexOf(d), 1) :
                    pGuild.settings.themeConfig.themes.splice(pGuild.settings.themeConfig.themes.indexOf(d), 1));
        ...
        switch (type) {
            case DecidablesEnum.Giveaway: return pGuild.settings.giveawayConfig.giveaways;
            case DecidablesEnum.Poll: return pGuild.settings.pollConfig.polls;
            case DecidablesEnum.Suggestion: return pGuild.settings.suggestionConfig.suggestions;
            case DecidablesEnum.Theme: return pGuild.settings.themeConfig.themes;
        }
    });
}
...
function UpdatePGuild(client, pGuild, decidableType, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield PinguGuild_1.PinguGuild.UpdatePGuild(client, (decidableType == DecidablesEnum.Giveaway ? { giveawayConfig: pGuild.settings.giveawayConfig } :
            decidableType == DecidablesEnum.Poll ? { pollConfig: pGuild.settings.pollConfig } :
                decidableType == DecidablesEnum.Suggestion ? { suggestionConfig: pGuild.settings.suggestionConfig } :
                    { themeConfig: pGuild.settings.themeConfig }), pGuild, `HandleDecidables: ${decidableType}`, succMsg, errMsg);
    });
}
function SaveVerdictToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        let { pGuild, message, decidablesType } = params;
        const arr = (decidablesType == DecidablesEnum.Giveaway ? pGuild.settings.giveawayConfig.giveaways :
...
function AddDecidableToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (decidablesType) {
            case DecidablesEnum.Giveaway: pGuild.settings.giveawayConfig.giveaways.push(decidable);
            case DecidablesEnum.Poll: pGuild.settings.pollConfig.polls.push(decidable);
            case DecidablesEnum.Suggestion: pGuild.settings.suggestionConfig.suggestions.push(decidable);
            case DecidablesEnum.Theme: pGuild.settings.themeConfig.themes.push(decidable);
        }
