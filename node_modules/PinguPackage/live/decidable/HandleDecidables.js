...
const database_1 = require("../database"); //PItems
...
function HandleDecidables(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let embed = new discord_js_1.MessageEmbed()
            ...
            .setDescription((Is(DecidablesTypes.Giveaway) || Is(DecidablesTypes.Theme) ? (`React with ${reactionEmojis[0]} to enter!\n` +
            `Winners: **${winners}**\n` +
        ...
        //Giveaway reroll
        if (reroll())
            return yield Reroll(params, embed, (Is(DecidablesTypes.Giveaway) ? pGuild.giveawayConfig.giveaways : pGuild.themeConfig.themes).find(d => d._id == value));
        //Announce decidable
        ...
        let decidable = new items_1.Decidable(value, sent.id, new database_1.PGuildMember(message.member), decidablesChannel, endsAt);
        ...
        function UpdateTimer() {
            sent.edit(sent.embeds[0].setDescription(Is(DecidablesTypes.Giveaway) || Is(DecidablesTypes.Theme) ? (`React with ${reactionEmojis[0]} to enter!\n` +
                `Winners: **${winners}**\n` +
                `Ends in: ${new helpers_1.TimeLeftObject(new Date(Date.now()), endsAt).toString()}\n` +
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pRole = DecidablesTypes.Giveaway == decidablesType ? config.hostRole :
            DecidablesTypes.Poll == decidablesType ? config.pollRole :
                DecidablesTypes.Suggestion == decidablesType ? config.managerRole :
                    config.hostRole;
...
function FirstTimeExecuted(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let staffRoleType = decidablesType == DecidablesTypes.Giveaway ? 'Giveaway Host' :
        ...
        collector.on('collect', (input) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (collectorCount) {
                ...
                case 4:
                    ...
                    if (DecidablesTypes.Giveaway == decidablesType)
        ...
        function HasAllArguments() {
            return __awaiter(this, void 0, void 0, function* () {
                 ...
                 */
                if (DecidablesTypes.Giveaway == decidablesType && args.length != 5)
                    return false; //Not enough arguments
                else if (DecidablesTypes.Theme == decidablesType && args.length != 6)
                    return false; //Not enough arguments
        ...
        function GoodToGo(params) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let channel = decidablesChannel && decidablesChannel != 'undefined' ? new database_1.PChannel(decidablesChannel) : undefined;
                let managerRole = staffRole && staffRole != 'undefined' ? new database_1.PRole(staffRole) : undefined;
                let finalWinnerRole = winnerRole && winnerRole != 'undefined' ? new database_1.PRole(winnerRole) : undefined;
                switch (decidablesType) {
                    ...
                    case DecidablesTypes.Suggestion:
                        ...
                        break;
                    case DecidablesTypes.Theme:
                        pGuild.themeConfig = new config_1.ThemeConfig({
...
function ListDecidables(params, decidables) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        reactionCollector.on('collect', (reaction) => __awaiter(this, void 0, void 0, function* () {
            let decidable = decidables.find(d => d._id == ([DecidablesTypes.Giveaway, DecidablesTypes.Theme].includes(decidablesType) ?
        ...
        function CreateEmbeds(autocalled) {
            ...
            for (var i = 0; i < decidables.length; i++) {
                try {
                    embeds[i] = ([DecidablesTypes.Giveaway, DecidablesTypes.Theme].includes(decidablesType) ? CreateGiveawayEmbed(decidables[i]) :
...
function AfterTimeOut(sent, value, amountOfWinners, embed, decidable, interval, params, previousWinner) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (decidablesType == DecidablesTypes.Poll)
            ...
            GetGiveawayWinner(decidablesType == DecidablesTypes.Giveaway ? decidable : decidable);
        ...
        function GetGiveawayWinner(decidable) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const config = decidablesType == DecidablesTypes.Giveaway ? pGuild.giveawayConfig : pGuild.themeConfig, winnerRole = config.winnerRole, allowSameWinner = config.allowSameWinner;
                let winners = new Array();
                try {
                    var peopleReacted = (yield sent.reactions.cache.get(`${params.reactionEmojis[0]}`).users.fetch()).array();
                }
                catch (err) {
                    yield PinguLibrary_1.PinguLibrary.errorLog(sent.client, `Fetching ${params.reactionEmojis[0]} reactions from ${decidablesType.toLowerCase()}`, sent.content, err);
                ...
                for (var i = 0; i < winners.length; i++) {
                    yield sent.guild.member(winners[i]).roles.add(winnerRole._id)
                        ...
                        if (err != `TypeError [INVALID_TYPE]: Supplied roles is not a Role, Snowflake or Array or Collection of Roles or Snowflakes.`) {
                            yield PinguLibrary_1.PinguLibrary.errorLog(sent.client, `Unable to give <@${winner.id}> "${sent.guild.name}"'s Giveaway Winner Role, ${winnerRole.name} (${winnerRole._id})`, message.content, err);
                ...
                sent.edit(embed
                    ...
                    .setFooter(`${decidablesType} ended.`)).catch(err => PinguLibrary_1.PinguLibrary.errorLog(sent.client, `Editing the ${decidablesType} Message`, sent.content, err)
                ...
                function UpdatePGuildWinners() {
                    return __awaiter(this, void 0, void 0, function* () {
                        for (var i = 0; i < winners.length; i++) {
                            decidable.winners.push(new database_1.PGuildMember(sent.guild.member(winners[i])));
                        }
                    });
                }
            });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        decidables.forEach(d => type == DecidablesTypes.Giveaway ? pGuild.giveawayConfig.giveaways.splice(pGuild.giveawayConfig.giveaways.indexOf(d), 1) :
            type == DecidablesTypes.Poll ? pGuild.pollConfig.polls.splice(pGuild.pollConfig.polls.indexOf(d), 1) :
                type == DecidablesTypes.Suggestion ? pGuild.suggestionConfig.suggestions.splice(pGuild.suggestionConfig.suggestions.indexOf(d), 1) :
                    pGuild.themeConfig.themes.splice(pGuild.themeConfig.themes.indexOf(d), 1));
        ...
        switch (type) {
            ...
            case DecidablesTypes.Theme: return pGuild.themeConfig.themes;
        }
    });
}
...
function Decide(params, approved, suggestion, decidedBy) {
    return __awaiter(this, void 0, void 0, function* () {
        suggestion = items_1.Suggestion.Decide(suggestion, approved, new database_1.PGuildMember(decidedBy));
        ...
        return yield PinguGuild_1.PinguGuild.UpdatePGuild(client, (decidableType == DecidablesTypes.Giveaway ? { giveawayConfig: pGuild.giveawayConfig } :
            decidableType == DecidablesTypes.Poll ? { pollConfig: pGuild.pollConfig } :
                decidableType == DecidablesTypes.Suggestion ? { suggestionConfig: pGuild.suggestionConfig } :
                    { themeConfig: pGuild.themeConfig }), pGuild, `HandleDecidables: ${decidableType}`, succMsg, errMsg);
    });
}
function SaveVerdictToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        let { pGuild, message, decidablesType } = params;
        const arr = (decidablesType == DecidablesTypes.Giveaway ? pGuild.giveawayConfig.giveaways :
...
function AddDecidableToPGuilds(params, decidable) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (decidablesType) {
            ...
            case DecidablesTypes.Theme: pGuild.themeConfig.themes.push(decidable);
        }
