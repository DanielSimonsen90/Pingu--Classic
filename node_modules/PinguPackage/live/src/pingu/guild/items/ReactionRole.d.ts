...
export declare function OnReactionRemoveAll(message: Message, client?: Client): Promise<any>;
...
export declare class ReactionRole {
    ...
    static OnReactionRemoveAll(message: Message, client?: Client): Promise<any>;
