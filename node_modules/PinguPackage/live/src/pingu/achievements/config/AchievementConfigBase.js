...
class AchievementConfigBase {
    ...
    _notify(client, achievement, embed, channel, guild) {
        return __awaiter(this, void 0, void 0, function* () {
            let announceChannel = channel ? channel : yield client.channels.fetch(this.channel._id);
            let percentage = yield achievement.getPercentage(guild);
