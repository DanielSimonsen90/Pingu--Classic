...
export declare const Badges: Collection<IAmBadge, GuildEmoji>;
export declare function SetBadges(): Collection<IAmBadge, GuildEmoji>;
export declare function getBadges(user: User): Promise<GuildEmoji[]>;
export {};
