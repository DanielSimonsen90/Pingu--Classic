...
export declare class PinguLibrary {
    ...
    static Badges: Collection<("Pingu Developer" | "Discord Bot Developer") | ("Pingu Staff Member" | "Pingu Support Team" | "Pingu Moderator Team" | "Pingu Administrators") | ("Early Supporter" | "Patreon Supporter") | ("Partnered Developer" | "Partnered Server Owner"), import("discord.js").GuildEmoji>;
    static SetBadges(): Collection<("Pingu Developer" | "Discord Bot Developer") | ("Pingu Staff Member" | "Pingu Support Team" | "Pingu Moderator Team" | "Pingu Administrators") | ("Early Supporter" | "Patreon Supporter") | ("Partnered Developer" | "Partnered Server Owner"), import("discord.js").GuildEmoji>;
    static getBadges(user: User): Promise<import("discord.js").GuildEmoji[]>;
