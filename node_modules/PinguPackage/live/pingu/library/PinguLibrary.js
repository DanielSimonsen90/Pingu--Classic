...
exports.PinguLibrary = exports.RequestImage = exports.getEmote = exports.getImage = exports.DBExecute = exports.BlankEmbedField = exports.raspberryLog = exports.latencyCheck = exports.tellLog = exports.eventLog = exports.consoleLog = exports.pUserLog = exports.pGuildLog = exports.errorLog = exports.errorCache = exports.DanhoDM = exports.outages = exports.getTextChannel = exports.isPinguDev = exports.CacheDevelopers = exports.Developers = exports.getSharedServers = exports.getServer = exports.SavedServers = exports.PinguSupportInvite = exports.Permissions = exports.PermissionCheck = exports.PermissionGranted = void 0;
...
function errorLog(client, message, messageContent, err, params = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let errorID = exports.errorCache.size;
        //Write or append to errorfile
        let errorFilePath = `./errors/${errorID}.json`;
        fs.writeFile(errorFilePath, JSON.stringify(Object.assign(Object.assign({}, err), params)), () => consoleLog(client, `Created error file for error #${errorID}.`));
        //Send and react
        ...
        function sendMessage(content) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                sent.createReactionCollector(() => true).on('collect', (reaction, user) => {
