...
class PinguLibrary {
    ...
    static Developers(client) { return developers_1.Developers(client); }
    ...
    //#endregion
    //#region Log Channels
    static errorLog(client, message, messageContent, err) {
        return __awaiter(this, void 0, void 0, function* () {
            return logChannels_1.errorLog(client, message, messageContent, err);
        });
    }
