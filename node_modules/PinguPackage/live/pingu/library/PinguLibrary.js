...
function pGuildLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        var pinguGuildLog = getTextChannel(client, exports.SavedServers.PinguSupport(client).id, "pingu-guild-log-🏡");
        if (!pinguGuildLog)
...
function pUserLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        var pinguUserLog = getTextChannel(client, exports.SavedServers.PinguSupport(client).id, "pingu-user-log-🧍");
        if (!pinguUserLog)
        ...
        let pAchievements = (yield (function getAllPAchievements() {
            return __awaiter(this, void 0, void 0, function* () {
                switch (achieverType) {
                    ...
                    case 'GUILDMEMBER': return (yield PinguGuildMember_1.GetPGuildMember(achiever)).achievementConfig.achievements;
