...
function errorLog(client, message, messageContent, err) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!errorlogChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, 'Unable to find #error-log-⚠️ in Pingu Support, https://discord.gg/gbxRV4Ekvh');
...
function pGuildLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!pinguGuildLog)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, `Couldn't get #pingu-guild-log-🏡 in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
        if (err) {
...
function pUserLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!pinguUserLog)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, `Couldn't get #pingu-user-log-🧍 in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
        if (err) {
...
function consoleLog(client, message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!consoleLogChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, 'Unable to find #console-log-📝 in Pingu Support, https://discord.gg/gbxRV4Ekvh');
...
function eventLog(client, content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!eventLogChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, `Couldn't get #event-log-📹 channel in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
...
function tellLog(client, sender, reciever, message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!tellLogChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, `Couldn't get #tell-log-💬 channel in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
...
function latencyCheck(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!pingChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(message.client, `Couldn't get #ping-log-🏓 channel in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
...
function raspberryLog(client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!raspberryLogChannel)
            return PinguLibrary_1.PinguLibrary.DanhoDM(client, `Couldn't get #raspberry-log-🍇 channel in Pingu Support, https://discord.gg/gbxRV4Ekvh`);
