...
function pGuildLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        var pinguGuildLog = PinguLibrary_1.PinguLibrary.getChannel(client, this.SavedServers.PinguSupport(client).id, "pingu-guild-log-🏡");
        if (!pinguGuildLog)
...
function pUserLog(client, script, message, err) {
    return __awaiter(this, void 0, void 0, function* () {
        var pinguUserLog = PinguLibrary_1.PinguLibrary.getChannel(client, this.SavedServers.PinguSupport(client).id, "pingu-user-log-🧍");
        if (!pinguUserLog)
