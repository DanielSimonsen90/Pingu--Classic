...
export declare function errorLog(client: Client, message: string, messageContent?: string, err?: Error): Promise<Message>;
...
export declare function raspberryLog(client: Client): Promise<any>;
