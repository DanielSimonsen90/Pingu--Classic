                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    switch (achieverType) {
                        ...
                        case 'GUILDMEMBER':
                            ...
                            return PinguGuildMember_1.UpdatePGuildMember(guildMember, pGuildMember, scriptName, `Added ${achieverType.toLowerCase()} achievement, #${pAchievement._id} "${achievement.name}" to **${achiever.user.tag}**'s PinguGuildMember achievements collection`);
                        case 'GUILD':
