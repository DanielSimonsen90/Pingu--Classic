...
export declare class GuildAchievementConfig extends AchievementConfigBase {
    ...
    static notify(client: Client, achiever: Guild, achievement: GuildAchievement<GuildAchievementTypeKey, GuildAchievementType[GuildAchievementTypeKey]>, config: GuildAchievementConfig): Promise<any>;
}
export {};
