...
exports.PinguUser = exports.GetPUsers = exports.DeletePUser = exports.UpdatePUser = exports.GetPUser = exports.WritePUser = void 0;
...
function UpdatePUser(client, updatedProperty, pUser, scriptName, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield PinguUser_1.PinguUserSchema.updateOne({ _id: pUser._id }, updatedProperty, null, err => {
            if (err)
                PinguLibrary_1.pUserLog(client, scriptName, errMsg, err);
            else
                PinguLibrary_1.pUserLog(client, scriptName, succMsg);
        });
    });
