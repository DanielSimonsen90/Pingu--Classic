...
function WritePUser(client, user, scriptName, reason) {
    return __awaiter(this, void 0, void 0, function* () {
        return PinguLibrary_1.DBExecute(client, (mongoose) => __awaiter(this, void 0, void 0, function* () {
            ...
            const log = new helpers_1.Reason('create', 'PinguUser', reason);
...
function UpdatePUser(client, updatedProperties, pUser, scriptName, reason) {
    return __awaiter(this, void 0, void 0, function* () {
        yield PinguUser_1.PinguUserSchema.updateOne({ _id: pUser._id }, getUpdatedProperty(), null, (err) => __awaiter(this, void 0, void 0, function* () {
            const log = new helpers_1.Reason('update', 'PinguUser', reason);
            if (err)
        ...
        function getUpdatedProperty() {
            ...
            for (const prop of updatedProperties) {
                switch (prop) {
                    case 'tag': result.tag = pUser.tag;
                    case 'sharedServers': result.sharedServers = pUser.sharedServers;
                    case 'marry': result.marry = pUser.marry;
                    case 'replyPerson': result.replyPerson = pUser.replyPerson;
                    case 'daily': result.daily = pUser.daily;
                    case 'playlists': result.playlists = pUser.playlists;
                    case 'achievementConfig': result.achievementConfig = pUser.achievementConfig;
...
function DeletePUser(client, user, scriptName, reason) {
    return __awaiter(this, void 0, void 0, function* () {
        yield PinguUser_1.PinguUserSchema.deleteOne({ _id: user.id }, null, err => {
            const log = new helpers_1.Reason('delete', 'PinguUser', reason);
            if (err)
