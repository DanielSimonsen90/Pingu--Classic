...
function HandleEvent(caller, client, path, ...args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var parameters = args.reduce((result, arg) => Object.assign(result, arg), {});
        function execute() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
        ...
        var [user, guild, guildMember] = [
            ...
            (parameters.guild || FindClass("Guild")),
            (parameters.member || FindClass("GuildMember")),
        ];
        ...
        function SendToLog() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (caller == 'message' && ['event-log-📹', 'ping-log-🏓', 'console-log-📝'].includes(parameters.channel.name))
                    return;
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        switch (event.name) {
                            ...
                            case 'channelPinsUpdate': return !parameters.guild ? parameters.recipient.tag :
                                ((yield GetInfo(parameters.guild, 'MESSAGE_PIN')) || GetInfo(parameters.guild, 'MESSAGE_UNPIN'));
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        function getColor() {
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                try {
                                    return (yield PinguGuild_1.PinguGuild.Get(PinguLibrary.SavedServers.PinguSupport(client))).clients.find(c => c._id == client.user.id).embedColor;
                                }
                                catch (_a) {
