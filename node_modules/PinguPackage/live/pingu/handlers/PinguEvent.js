...
function HandleEvent(caller, client, path, ...args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        PinguLibrary_1.AchievementCheck(client, {
            user: parameters.author || parameters.user || parameters.inviter || FindClass("User") ||
                parameters.users && parameters.users.first && parameters.users.first() ||
                parameters.last && parameters.last(),
            guild: parameters.guild || FindClass("Guild"),
            guildMember: parameters.member || FindClass("GuildMember"),
        }, 'EVENT', caller, args);
        function SendToLog() {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        function FindClass(type) {
            const objectsOfClass = args.filter(a => a.constructor.name == type);
            return objectsOfClass[objectsOfClass.length - 1];
        }
    });
}
