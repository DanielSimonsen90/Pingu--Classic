import { Client, Message, Guild, User, MessageEmbed, GuildAuditLogsAction, ClientEvents } from 'discord.js';
...
export declare class PinguEvent<Event extends keyof PinguClientEvents> extends PinguHandler {
    ...
    constructor(name: Event, setContent?: (...args: PinguClientEvents[Event]) => Promise<MessageEmbed>, execute?: (client: PinguClient, ...args: PinguClientEvents[Event]) => Promise<Message>);
    name: Event;
    path: string;
