...
exports.PinguGuild = exports.GetPGuilds = exports.DeletePGuild = exports.UpdatePGuild = exports.GetPGuild = exports.WritePGuild = void 0;
...
function UpdatePGuild(client, updatedProperty, pGuild, scriptName, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        PinguGuild_1.PinguGuildSchema.updateOne({ _id: pGuild._id }, updatedProperty, null, err => {
            if (err)
