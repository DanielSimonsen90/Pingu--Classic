...
export declare function UpdatePGuild(client: Client, updatedProperty: PinguGuildUpdate, pGuild: PinguGuild, scriptName: string, succMsg: string, errMsg: string): Promise<any>;
...
export declare class PinguGuild extends PItem {
    ...
    static UpdatePGuild(client: Client, updatedProperty: PinguGuildUpdate, pGuild: PinguGuild, scriptName: string, succMsg: string, errMsg: string): Promise<any>;
