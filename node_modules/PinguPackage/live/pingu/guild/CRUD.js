...
const PinguGuild_2 = require("../../MongoSchemas/PinguGuild");
function WritePGuild(client, guild, scriptName, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        PinguLibrary_1.PinguLibrary.DBExecute(client, (mongoose) => __awaiter(this, void 0, void 0, function* () {
            let created = yield new PinguGuild_2.PinguGuildSchema(new PinguGuild_1.PinguGuild(guild, !guild.owner ? guild.member(yield client.users.fetch(guild.ownerID)) : null));
            if (!created)
...
function GetPGuild(guild) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!guild)
            return null;
        let pGuildDoc = yield PinguGuild_2.PinguGuildSchema.findOne({ _id: guild.id }).exec();
...
function UpdatePGuild(client, updatedProperty, pGuild, scriptName, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        PinguGuild_2.PinguGuildSchema.updateOne({ _id: pGuild._id }, updatedProperty, null, err => {
            if (err)
...
function DeletePGuild(client, guild, scriptName, succMsg, errMsg) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield PinguGuild_2.PinguGuildSchema.deleteOne({ _id: guild.id }, null, err => {
            if (err)
...
function GetPGuilds() {
    return __awaiter(this, void 0, void 0, function* () {
        return (yield PinguGuild_2.PinguGuildSchema.find({}).exec()).map(collDoc => collDoc.toObject());
    });
}
