...
const PinguCollection_1 = require("../../helpers/PinguCollection");
const DeveloperCollection_1 = require("../../helpers/DeveloperCollection");
const database_1 = require("../../database");
const PermissionsManager_1 = require("../PermissionsManager");
const PinguCacheManager_1 = require("../PinguCacheManager");
const EmojiCollection_1 = require("../EmojiCollection");
...
class BasePinguClient extends discord_js_1.Client {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logChannels = (() => {
                return new discord_js_1.Collection(new discord_js_1.Collection([
                    ...
                    const logChannels = this.savedServers.get('Pingu Support').channels.cache.find(c => c.name.includes('Log Channels'));
            ...
            yield Promise.all([this.pGuilds.refresh(this), this.pUsers.refresh(this), this.emotes.refresh(this)]);
        });
    }
    //#endregion
    //#region Log Methods
    ...
    errorLog(channel, message, messageContent, err, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sent = yield sendMessage(this, getErrorMessage(message, messageContent, err)).catch(err => sentCatcher(err, 'txt'));
            let paramsSent = yield sendMessage(this, "```\n[Parameters]:\n" + jsonErrorContent + "\n```").catch(err => sentCatcher(err, 'json'));
            //Add to errorCache
            ...
            function sendMessage(client, content) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield sent.react(client.savedServers.get('Danho Misc').emojis.cache.find(e => e.name == 'Checkmark')); //Mark as solved
                    ...
                    sent.createReactionCollector(() => true).on('collect', (reaction, user) => __awaiter(this, void 0, void 0, function* () {
                        if (!client.developers.isPinguDev(user) || !reaction.users.cache.has(client.user.id))
