...
function GetPGuildMember(member) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (pgm)
            return pgm.toObject ? pgm.toObject() : pgm;
        ...
        yield PinguGuild_1.UpdatePGuild(member.client, ['members'], pGuild, 'GetPGuildMember()', `Added **${pgm.name}** as a member of **${pGuild.name}**.`);
        return pgm;
    });
}
