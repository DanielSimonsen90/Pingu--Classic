...
function WritePGuildMember(member, scriptName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!config.achievements.notificationTypes) {
            ...
            yield client.pGuilds.update(pGuild, `WritePGuildMember: ${scriptName}`, 'PinguGuild did not have NotificationType');
        }
        ...
        yield client.pGuilds.update(pGuild, scriptName, `${user.tag} was added to ${pGuild.name}'s PinguGuild.members.`);
        //Add join achievement
        yield achievements_1.AchievementCheckType(client, 'GUILDMEMBER', member, 'EVENT', 'guildMemberAdd', pGuildMember.achievementConfig, 'EVENT', [member]);
        return pGuildMember;
    });
}
