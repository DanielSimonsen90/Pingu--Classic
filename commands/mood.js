module.exports = {
    ...
    execute(message, args) {
        ...
        switch (MoodNumber) {
            case 1:
                Mood = `I'm not feeling so good...`;
                break;
            case 2:
                Mood = `I'm feeling kinda tired..`;
                break;
            case 3:
                Mood = `I'm hungry. Isn't it food time soon?`;
                break;
            case 4:
                Mood = `I'm feeling pretty good tbh`;
                break;
            case 5:
                Mood = `I'm not too bad tbh`
            default:
                Mood = `Idk what I'm feeling man... L-LEAVE ME **ALONE**! :)`
        }
