...
import { 
    ...
    Collection, Guild, User,
    Message, MessageEmbed, MessageAttachment,
...
import PinguBadge, { IAmBadge, TempBadges } from '../badge/PinguBadge';
...
import { TimestampStyle, TimestampStyles } from "../../helpers/TimeLeftObject";
