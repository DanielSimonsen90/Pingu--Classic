...
export class UserAchievementConfig extends AchievementConfigBase {
    ...
    public static async notify<Key extends keyof UserAchievementType>(client: PinguClientBase, achiever: User, achievement: UserAchievement<Key, UserAchievementType[Key]>, config: UserAchievementConfig) {
